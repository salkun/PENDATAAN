        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <p class="text-muted small mb-0">Lihat ringkasan data barang dan riwayat transaksi.</p>
                </div>
                <div class="col-sm-6 text-sm-end mt-2 mt-sm-0">
                    <ol class="breadcrumb justify-content-sm-end mb-0 bg-transparent p-0">
                        <li class="breadcrumb-item"><a href="<?= $base_url ?>/user/dashboard.php" class="text-decoration-none text-success">Home</a></li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom border-light pt-4 px-4 pb-3 d-flex flex-column flex-sm-row align-items-sm-center gap-3">
                    ...
                    <div class="ms-sm-auto text-end">
                        <a href="cetak_laporan.php?jenis=<?= urlencode($jenis_laporan) ?>&id_barang=<?= urlencode($id_barang) ?>&bulan_tahun=<?= urlencode($bulan_tahun) ?>" 
                           target="_blank" 
