...
<body>
    ...
    <div class="kop-surat">
        <!-- Because $base_url is not reliably set in plain files if not included from templates, we use absolute relative path -->
        <img src="../../assets/img/logo-pa.png" alt="Logo PA">
        <div class="kop-text">
            <h1>PENGADILAN AGAMA</h1>
            <h2>Sistem Inventarisasi & Manajemen Barang</h2>
            <p>Ir. Haji Juanda Desa No.3, Mekargalih, Kec. Jatiluhur, Kabupaten Purwakarta, Jawa Barat 14150</p>
        </div>
    </div>
    ...
    <div class="ttd">
        <p>Mengetahui,</p>
        <p><b>Admin Inventaris</b></p>
        <p class="nama"><?= htmlspecialchars($_SESSION['nama_lengkap']) ?></p>
        <p>NIP. -</p>
    </div>

    <!-- Script to auto open print dialog after brief delay so images load -->
    <script>
